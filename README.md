...
[![Version](https://img.shields.io/badge/version-2.0.0-blue.svg)](https://github.com/Hiimeka/xynera/selfbot)
...
## 🚀 **Xynera Protocol** adalah selfbot Discord canggih dengan fitur lengkap untuk automation dan kontrol penuh atas akun Discord Anda.
...
### 🎨 **Customizable**
- ✅ Ubah semua config di `config.py`
- ✅ Support `.env` file untuk keamanan
...
# 5. Edit config.py dengan token dan ID channel
notepad config.py
